Public Class FormRegister
    Private Sub ButtonRegister_Click(sender As Object, e As EventArgs) Handles ButtonLogin.Click
        If (validateRegister()) Then
            FormLogin.Users.AddUserDatabase(TextBoxUsername.Text, TextBoxPassword.Text)
